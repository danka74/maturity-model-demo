...
import { DataOperation } from "@prisma/client";
...
export default async function SystemFunctionComponent() {
    ...
    async function create(formData: FormData) {
        ...
        revalidatePath('/data_operations');
    };
    ...
    async function _delete(formData: FormData) {
        ...
        await prisma.dataOperation.delete({
            where: {
                id: id2,
            },
        });
    ...
    let dataOperations = await prisma.dataOperation.findMany();
    return (
        <>
            <div className="container mx-auto">
                <main className="grid grid-cols-1">
                    ...
                    {dataOperations.map((dop: DataOperation) => (
